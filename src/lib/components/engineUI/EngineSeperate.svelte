...
<Dialog bind:this={modalContainer}>
    <h2>Are you sure you wish to delete the engine {#if engineID !== undefined}
        {engineID}
    {/if}</h2>
    <form method="dialog">
...
<form bind:this={formElement}>
    <button type="button" id="show-modal" on:click={showModal}>Delete</button> <br>
    <label for="name">Name:</label>
    <input type="text" placeholder="Name" name="name" bind:this={nameContainer}/> <br>
    ...
    <input type="text" placeholder="7000" name="IP" /> <br>
    <input type="radio" id="reveaal" name="engine_type" value="Reveaal" checked={defaultChecked == 0}>
    <label for="reveeal">Reveaal</label> <br>
    <input type="radio" id="jecdar" name="engine_type" value="JEcdar" checked={defaultChecked == 1}>
    <label for="jecdar">JEcdar</label> <br>
    <input type="radio" id="reveaalapi" name="engine_type" value="API" checked={defaultChecked == 2}>
