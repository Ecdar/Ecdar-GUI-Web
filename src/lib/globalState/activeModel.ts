...
import { Invariant, LocationType, Nickname, Property, PropertyType, Status, Urgency } from '$lib/classes/automaton';
	...
	new ActiveModel(
		{
            ...
            '4': {
                ...
                id: '4',
                invariant: new Invariant('c >= 10', { x: 700, y: 700 }), // Example invariant
                nickname: new Nickname('nickname4', { x: 700, y: 700 }), // Example nickname
                position: { x: 700, y: 700 }, // Example position
		...
		[
            ...
            // Add more edge objects here for additional connections
            {
				...
				nails: [{
					position: {x: 100, y: 100},
					property: new Property(PropertyType.GUARD, {x: 100, y: 100})
				}]
            },
            {
                guard: 'c >= 10',
