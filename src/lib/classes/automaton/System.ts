 ...
 * An Ecdar System
 * */
export class System implements Raw.SerializeRaw, Raw.ToRaw<Raw.RawSystem> {
	/**
	 ...
	 * */
	static fromRaw: Raw.FromRaw<Raw.RawSystem, System> = (raw) => {
		return new System(
			raw.name,
			raw.description,
	 ...
	 * */
	static deserializeRaw: Raw.DeserializeRaw<System> = (input) => {
