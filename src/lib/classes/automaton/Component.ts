...
export class Component
	implements Raw.SerializeRaw, Raw.ToRaw<Raw.RawComponent>
{
	/**
	 ...
	 * */
	static fromRaw: Raw.FromRaw<Raw.RawComponent, Component> = (raw) => {
	 ...
	 * */
	static deserializeRaw: Raw.DeserializeRaw<Component> = (input) => {
